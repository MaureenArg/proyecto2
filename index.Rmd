...
renderDT({
  ...
  registros %>%
    st_drop_geometry() %>%
    datatable(rownames= FALSE, filter= "top", class= "hover cell-border stripe", colnames = c( "Tipo de denuncia", "Detalle de la denuncia", "Año",  "Provincia"), options = list (language = list (url = "//cdn.datatables.net/plug-ins/1.10.11/i18n/Spanish.json"),pageLength = 2, dom = "Bfrtip"))
})
```
